            ...
            <div className='qualification__sections'>
                <div className={toggleState === 1 ? 'qualification__content qualification__content-active' : "qualification__content"}>
                    <div className='qualification__data'>
                        <div>
                            <h3 className='qualification__title'>Master's
                            </h3>
                    ...
                    <div className='qualification__data'>
                        ...
                        <div>
                            <h3 className='qualification__title'> Bachelor's
                            </h3>
                            <span className='qualification__subtitle'>
                                Visveswarya Technological Unviersity
                            </span>
                            <div className='qualification__calendar'>
                ...
                <div className={toggleState === 2 ? 'qualification__content qualification__content-active' : "qualification__content"}>
                    ...
                    <div className='qualification__data'>
                        ...
                        <div>
                            <h3 className='qualification__title'> Associate Technical Specialist
                            </h3>
                            <span className='qualification__subtitle'>
                                Digital API Craft Pvt Ltd.
                            </span>
                            <div className='qualification__calendar'>
