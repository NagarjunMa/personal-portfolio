...
const Data = () => {
  return (
    <div className='home__data'>
        ...
        <p className='home__description'>I'm Full Stack Developer based in Boston, and I'm very passionate and dedicated to my work. 
        Capturing the world one frame at a time.</p>
